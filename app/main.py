...
COUTRIES = {
    "RU": "РФ OR Российская OR Федерация OR Россия OR России OR Москва",
    "US": "США OR Соединённые OR Штаты OR Америки OR Америка OR Вашингтон",
    "CA": "Канада OR канадский OR Канады",
    "GL": "Гренландия OR Нуук",
    "MX": "Мексика OR Мексиканские OR мексиканский OR Мехико",
    "NO": "Норвегия OR Норвежские OR норвежский OR Осло",
    "FI": "Финляндия OR Финские OR финский OR Хельсинки",
    "SE": "Швеция OR Шведские OR швецкий OR Стокгольм",
    "DK": "Дания OR Дании OR Датские OR датский OR Копенгаген",
    "GB": "Великобритания OR Соединённое OR Королевство OR Британия OR Лондон",
    "CN": "Китай OR Китайская OR Народная OR Республика OR Пекин",
    "IR": "Иран OR Иранские OR иранские OR Ирана OR Тегеран",
    "FR": "Франция OR Французские OR Франции OR французы OR Париж",
    "IL": "Израиль OR Израильские OR Израиля OR Иерусалим",
    "PL": "Польша OR Польские OR Польши OR Варшава",
    "BR": "Бразилия OR Бразильские OR Бразилии OR Бразилиа",
}
